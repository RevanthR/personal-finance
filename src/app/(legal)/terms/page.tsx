  ...
  return (
    <article className="prose prose-zinc max-w-none">
      ...
      <section className="space-y-6 text-sm leading-relaxed text-muted-foreground">
        ...
        <div>
          <h2 className="text-base font-semibold text-foreground mb-2">6. Data and Privacy</h2>
          <p>Your use of the Service is also governed by our <a href="/privacy" className="text-foreground underline">Privacy Policy</a>. Financial data you enter is stored securely and used solely to provide the Service to you.</p>
        </div>
        ...
        <div>
          ...
          <p>For questions about these Terms, contact us at <a href="mailto:revanth.rallabandi@gmail.com" className="text-foreground underline">revanth.rallabandi@gmail.com</a>.</p>
        </div>
      </section>
    </article>
  );
