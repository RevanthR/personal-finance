    ...
    <article className="prose prose-zinc max-w-none">
      ...
      <section className="space-y-6 text-sm leading-relaxed text-muted-foreground">
        ...
        <div>
          ...
          <ul className="list-disc pl-5 space-y-1">
            <li><strong>Google OAuth:</strong> Used for authentication. Governed by <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer" className="text-foreground underline">Google&apos;s Privacy Policy</a>.</li>
            <li><strong>Razorpay:</strong> Used for payment processing. Governed by <a href="https://razorpay.com/privacy/" target="_blank" rel="noopener noreferrer" className="text-foreground underline">Razorpay&apos;s Privacy Policy</a>.</li>
            <li><strong>Vercel:</strong> Hosting provider. Governed by <a href="https://vercel.com/legal/privacy-policy" target="_blank" rel="noopener noreferrer" className="text-foreground underline">Vercel&apos;s Privacy Policy</a>.</li>
          </ul>
        </div>
        ...
        <div>
          ...
          <p>You have the right to access, correct, or delete your personal data. To exercise these rights, contact us at <a href="mailto:revanth.rallabandi@gmail.com" className="text-foreground underline">revanth.rallabandi@gmail.com</a>.</p>
        </div>
        ...
        <div>
          ...
          <p>For privacy-related questions, contact <a href="mailto:revanth.rallabandi@gmail.com" className="text-foreground underline">revanth.rallabandi@gmail.com</a>.</p>
        </div>
      </section>
    </article>
  );
